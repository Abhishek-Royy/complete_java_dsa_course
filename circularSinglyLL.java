...
public class circularSinglyLL {
    ...
    public void travarseSinglyLL() {
        ...
        Node temp = head;
        do {
            System.out.print(temp.data + "->");// this will be run atleast once without checking any condition.
            temp = temp.next;
    ...
    public static void main(String[] args) {
        ...
        // list.travarseSinglyLL();
        list.insertAtTail(65);
        list.insertAtTail(44);
        list.insertAtTail(91);

        // list.travarseSinglyLL();
        list.insertAtPosition(3, 101);
        // list.travarseSinglyLL();
